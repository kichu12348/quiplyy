  ...
  return (
    <SafeAreaView style={styles.container(theme.theme)}>
      <View style={styles.header}>
        ...
        >
          <Image source={theme.Icons.return} style={styles.backIcon} />
        </TouchableOpacity>
        <Text style={styles.title(theme.theme)}>Stuff</Text>
      </View>
      <View style={styles.stuffContainer}>
        ...
        >
          ...
          {isSnowfallPlaying && playbackStatus?.positionMillis / playbackStatus?.durationMillis !== 1 && (
            <View
              style={styles.timeStamps((playbackStatus?.positionMillis / playbackStatus?.durationMillis) * 100 + 4.5,theme.theme)}
            />
          )}
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          {isCalmPlaying && playbackStatus?.positionMillis / playbackStatus?.durationMillis !== 1 && (
            <View
              style={
                styles.timeStamps((playbackStatus?.positionMillis / playbackStatus?.durationMillis) * 100 + 4.5,theme.theme)
                }
            />
          )}
        </TouchableOpacity>
